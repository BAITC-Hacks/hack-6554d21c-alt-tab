...
Результат реального прогона 2026-09-23 после правил языка в prompt (gpt-4.1-mini,
без контекста сессии, 104/104 вызовов успешны; в скобках — предыдущий прогон):

| Группа | n | primary_acc | full_match |
|---|---|---|---|
| all | 104 | 0.962 (0.971) | 0.962 (0.952) |
| lang=kk | 45 | 0.978 (1.000) | 0.978 |
| lang=mixed | 7 | 1.000 | 1.000 (0.857) |
| lang=ru | 52 | 0.942 | 0.942 |
| type=multi_intent | 13 | 0.923 | 0.923 (0.846) |
| type=unclear | 3 | 0.333 | 0.333 |

intent_recall (multi-intent) 0.962 (0.923). Ошибки — 4: соседний сценарий SC16 вместо
SC15 (U030, травма за рубежом), пропущено второе намерение (U090), два коротких неясных
запроса вместо `SYS_UNCLEAR` отнесены к сценарию (U102, U104). Разница между прогонами —
в пределах колебаний модели на одной реплике. Dev-набор — диагностика, не цель подгонки;
predictions и отчёт лежат в `artifacts/` (не в Git).
